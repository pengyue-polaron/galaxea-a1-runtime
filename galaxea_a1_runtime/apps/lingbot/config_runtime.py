...
def bash_config(config: LingBotConfig) -> str:
    ...
    values = (
        ...
        ("MODEL_ROOT", str(config.policy_server.transformer_root)),
        ("MODEL_FOUNDATION_ROOT", str(config.policy_server.foundation_root)),
        ...
        ("RECORDING_OUTPUT_ROOT", str(config.recording.output_root)),
