...
from galaxea_a1_runtime.lerobot.lingbot_pack import ACTION_NAMES, USED_ACTION_CHANNEL_IDS, load_pack_config
from galaxea_a1_runtime.lerobot.joint_pack import JOINT_ACTION_NAMES
from galaxea_a1_runtime.lerobot.v21 import _json_value

REPO_ROOT = Path(__file__).resolve().parents[1]
URDF = REPO_ROOT / "third_party/A1_SDK/install/share/mobiman/urdf/A1/urdf/A1_URDF_0607_0028.urdf"
...
def test_a1_urdf_chain_and_known_reset_pose():
    ...
    pose = chain.pose([0.012999535, 0.0010004044, -0.08199978, -1.5410004, 0.3540001, -0.048999786])
    expected = np.array(
        [0.06835637, 0.0022991674, 0.22050981, -0.016684923, 0.7965297, 0.0016861054, 0.6043668]
    )
...
def test_v21_json_conversion_handles_nested_numpy_values():
    ...
    assert _json_value(value) == [[1.0], [2.0]]
